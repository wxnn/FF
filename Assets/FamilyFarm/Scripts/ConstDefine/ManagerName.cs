...
namespace LuaFramework {
    public class ManagerName {
        ...
        public const string State = "stateManager";
        public const string MyData = "myDataManager";
        public const string FriendData = "friendDataManager";
        public const string Http = "HttpManager";
    }
}