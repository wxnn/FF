...
public class Packager {
    ...
    static void HandleExampleBundle() {
        ...
        AddBuildMap("promptpanel" + AppConst.ExtName, "*.prefab", "Assets/FamilyFarm/Examples/Builds/Prompt");
        AddBuildMap("messagepanel" + AppConst.ExtName, "*.prefab", "Assets/FamilyFarm/Examples/Builds/Message");

        AddBuildMap("prompt_asset" + AppConst.ExtName, "*.png", "Assets/FamilyFarm/Examples/Textures/Prompt");
        AddBuildMap("shared_asset" + AppConst.ExtName, "*.png", "Assets/FamilyFarm/Examples/Textures/Shared");
    }
    ...
    static void HandleLuaFile() {
        ...
        string[] luaPaths = { AppDataPath + "/FamilyFarm/lua/", 
                              AppDataPath + "/FamilyFarm/Tolua/Lua/" };
